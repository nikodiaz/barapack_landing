...
const Card: React.FC<Props> = ({ testimonial }) => {
	return (
		<article className='flex flex-col flex-grow items-center justify-center p-4 mx-2 my-8 md:h-80 rounded-lg shadow-lg'>
			<div className='relative flex items-center justify-center w-28 h-14 p-2 rounded-b-full inner-shadow-custom'>
				<div className='absolute -top-12 bg-gradient-to-br from-[#FBEDA5] to-[#F4D00E] rounded-full p-1 shadow-lg'>
					<div className='bg-gradient-to-br from-[#F0DF46] to-[#D9A41D] rounded-full p-1'>
						<img
							...
							src={`../../../public/testimonial/${testimonial.image}`}
						/>
					</div>
				</div>
			</div>
